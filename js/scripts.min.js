...
document.addEventListener("DOMContentLoaded", () => {
    ...
    gsap.to("#hero-text", { opacity: 1, y: -10, delay: 0.3 });

    gsap.utils.toArray(".anim-block").forEach(sec => {
        gsap.fromTo(sec,
            { opacity: 0, y: 50 },
            {
                opacity: 1,
    ...
    const headerTop = document.querySelector('.header__top-line');
    ...
    document.querySelectorAll('a.link-button[href^="#"').forEach(link => {
        link.addEventListener('click', function (e) {
            ...
            const topOffsetHeader = headerTop.offsetHeight;
    ...
    const swiperServices = new Swiper('.carousel-services', {
        loop: true,
        slidesPerView: 3,
        spaceBetween: 20,
        breakpoints: {
